...
initialize_floorplan -core_utilization 0.85 -core_aspect_ratio 0.4 -left_io2core 7 -bottom_io2core 7 -right_io2core 7 -top_io2core 7
...
# Save Verilog
write_verilog "$PROJ_DIR/backend/dgen/pnr/${my_toplevel}_signoff.v" \
...
# Save as GDS
write_stream -format gds "$PROJ_DIR/backend/dgen/pnr/${my_toplevel}.gds"
