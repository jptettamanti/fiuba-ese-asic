...
# DVE full session
# Saved on Sun Oct 20 16:39:05 2013
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 145} {height 432} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 431
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 145} {height 432} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1359} {height 150} {dock_state bottom} {dock_on_new_line true}}
...
catch { gui_list_select -id ${Data.1} {tb_mcu.tb_rst tb_mcu.tb_clk tb_mcu.tb_opcode tb_mcu.tb_psr_update tb_mcu.tb_opcode_update tb_mcu.tb_acc_update tb_mcu.tb_imm_update tb_mcu.tb_pc_count tb_mcu.tb_ram_write }}
